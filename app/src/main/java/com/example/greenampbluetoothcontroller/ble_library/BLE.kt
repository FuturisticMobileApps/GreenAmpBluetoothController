...
class BLE {
    ...
    private fun registerContracts() {
        ...
        this.adapterContract = ContractHandler(
            BluetoothAdapterContract(),
            this.componentActivity,
            this.appCompatActivity,
            this.fragment
        )
        this.permissionContract = ContractHandler(
            RequestMultiplePermissions(),
            this.componentActivity,
            this.appCompatActivity,
            this.fragment
        )
        this.locationContract = ContractHandler(
        ...
        scanCallbackInstance = object : ScanCallback() {
            ...
            override fun onScanResult(callbackType: Int, result: ScanResult?) {
                ...
                result?.device?.let { device ->
                    val advertisingID =
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) result.advertisingSid else -1
    ...
    suspend fun scanFor(
        ...
        return suspendCancellableCoroutine { continuation ->
            ...
            if (macAddress == null && service == null && name == null) throw IllegalArgumentException(
            ...
            this.coroutineScope.launch {
                ...
                val filters =
                    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) arrayListOf(filter) else null
